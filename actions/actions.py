...
class FormInfo(Action):
    ...
    async def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: "DomainDict") -> List[
        Dict[Text, Any]]:
        required_slot = ["1_activity", "2_outside", "3_workingtime", "4_environment", "5_company", "6_skills", "7_personally",
...
class ActionSubmit(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        # dataupdate(tracker.get_slot("student_group"), tracker.get_slot("1_activity"), tracker.get_slot(
        # "2_outside"), tracker.get_slot("3_workingtime"), tracker.get_slot("4_environment"), tracker.get_slot(
        # "5_company"), tracker.get_slot("6_skills"), tracker.get_slot("7_personally"), tracker.get_slot(
        # "8_problems_dealing"), tracker.get_slot("9_public"), tracker.get_slot("10_min_salary"), tracker.get_slot(
        # "11_wish_salary"))
